...
class BathroomLoader(bulkloader.Loader):
    def __init__(self):
        bulkloader.Loader.__init__(self, 'Bathroom', [
            ('key', str),
            ('parent', noneStr),
...
class BathroomExporter(bulkloader.Exporter):
    def __init__(self):
      bulkloader.Exporter.__init__(self, 'Bathroom', [
          ('key', str, None),
          ('parent', str, None),
          ('venue', str, None),
          ('created', str, None),
